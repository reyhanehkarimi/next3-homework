...
export default function RecipeDetails({ params }) {
  ...
  return (
    ...
    <div className="max-w-3xl mx-auto p-6 shadow-lg rounded-lg pt-10 bg-gradient-to-r from-red-50 via-white to-red-50">
      ...
      <div className="mt-4 text-gray-600 space-y-2">
        ...
        <p>
          <strong>Prep Time:</strong> {recipe.prepTimeMinutes || 0} minutes
        </p>
        <p>
          <strong>Cook Time:</strong> {recipe.cookTimeMinutes || 0} minutes
        </p>
        <p>
